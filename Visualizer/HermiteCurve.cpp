...
HermiteCurve::HermiteCurve(std::vector<Point2D> points, QVector<GLfloat>& curvePoints) : mControlPoints(points)
{
...
void HermiteCurve::calculateHermite(QVector<GLfloat>& cp)
{
